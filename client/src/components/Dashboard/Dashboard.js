...
export default function Dashboard() {
  ...
  const handleAddTask = (taskType) => {
    if (taskType === "lecture") {
      setTaskDialog("lecture");
    } else if (taskType === "tutorial") {
      setTaskDialog("tutorial");
    } else if (taskType === "homework") {
      setTaskDialog("homework");
    }
  };
        ...
        <div className="tasks-container">
          ...
          <div className="divider-container">
            ...
            <Fab
              ...
              onClick={() => handleAddTask("lecture")}
              aria-label="add"
              sx={{ backgroundColor: "rgb(55, 55, 172)" }}
            >
          ...
          <div className="divider-container">
            ...
            <Fab
              size="big"
              className="add-task-icon"
              onClick={() => handleAddTask("tutorial")}
              aria-label="add"
              sx={{ backgroundColor: "rgb(55, 55, 172)" }}
            >
              <AddIcon className="add-task-icon-sign" />
          ...
          <div className="divider-container">
            ...
            <Fab
              size="big"
              className="add-task-icon"
              onClick={() => handleAddTask("homework")}
              aria-label="add"
              sx={{ backgroundColor: "rgb(55, 55, 172)" }}
            >
              <AddIcon className="add-task-icon-sign" />
